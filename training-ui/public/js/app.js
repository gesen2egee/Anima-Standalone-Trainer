...
const UI_TRANSLATIONS = {
  ...
  "Interpolate SigLIP quality and DBAES aesthetic percentiles using each sampled timestep.": {
    "zh-TW": "依每次取樣時間步，在 SigLIP 品質百分位與 DBAES 美學百分位之間插值。",
    "zh-CN": "依每次采样时间步，在 SigLIP 品质百分位与 DBAES 美学百分位之间插值。",
  },
